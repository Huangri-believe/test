...
ROOT_DIR="/media/leju_kuavo/ED7D-7574/batch11-3/defult"
...
# === 主流程 ===
echo "🔍 查找 $ROOT_DIR 下所有 lerobot 目录..."
mapfile -t lerobot_dirs < <(find "$ROOT_DIR" -type d -name 'lerobot' 2>/dev/null | sort)
